...
private:
    ...
    static constexpr KnowledgeItem kKnowledgeItems[] = {
        ...
        {
            "family_safety",
            "着火 火情 火灾 烟雾 起火 家里着火 着火怎么办 起火怎么办 冒烟 119",
            "发现火情时，先提醒人员远离火源和浓烟，不要乘坐电梯；在安全位置通知家人，必要时拨打 119。不要让儿童或老人自行处理火源。"
        },
        {
            "family_safety",
            "摔倒 跌倒 老人 倒地 受伤 老人摔倒 老人跌倒 摔了 跌了 120 急救",
        ...
        {
            "caregiving",
            "服药 吃药 提醒 老人 药 服药提醒 吃药提醒 按时吃药 药量 医生",
    ...
    void InitializeRagTools() {
        ...
        mcp_server.AddTool(
            ...
            "检索 ESP32 固件内置的项目知识库。"
            "这是回答项目相关问题、设备使用问题和家庭陪护安全问题前必须优先调用的工具。"
            "当用户询问以下内容时，不要直接凭常识回答，必须先调用此工具："
            "小蠖/小智能做什么、怎么配网/联网、怎么看摄像头/远程画面、怎么调音量、怎么待机、"
            "家里着火怎么办、起火/冒烟怎么办、老人摔倒/跌倒怎么办、儿童陪伴、服药提醒、运动控制。"
